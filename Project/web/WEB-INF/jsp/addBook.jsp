...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/book/addBook" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="bookCounts" class="form-control" id="bookcount" placeholder="数量" required>
        </div>
        <div class="form-group">
            <label for="detail">书籍描述</label>
            <input type="text" name="detail" class="form-control" id="detail" placeholder="描述" required>
        </div>
        <div class="form-group">
